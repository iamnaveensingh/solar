        ...
        <div id="contact" className='bg-white dark:text-white  dark:bg-gray-900 p-2 '>
            ...
            <div className=' flex flex-wrap justify-around mb-2'>
                <div className='w-[400px] '>
                    ...
                    <p><b>Messgae: </b>Lorem,Eos est recusandae reprehenderit libero doloribus eaque eius totam voluptatum tenetur, perspiciatis, optio mollitia sed id temporibus inventore? Voluptates, expedita animi laudantium,   obcaecati, optio blanditiis.</p>

                </div>
                <div className='w-[400px] lg:my-auto lg:px-10  my-16'>
                    <div className="">
